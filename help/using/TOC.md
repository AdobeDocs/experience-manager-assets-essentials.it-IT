...
+ Introduzione ad Assets Essentials per amministratori {#get-started-admins}
   + [Amministrare e aggiungere utenti](deploy-administer.md)
   + Gestire l’accesso alla cartella{#folder-access}
...
+ [Modificare i metadati in blocco](/help/using/bulk-metadata-edit.md)
+ [Condividere le risorse](share-links-for-assets.md)
+ [Gestire le raccolte](manage-collections.md)
+ [Relazioni delle risorse](asset-relations.md)
...
+ [Video](https://experienceleague.adobe.com/it/docs/experience-manager-learn/assets-essentials/overview)
