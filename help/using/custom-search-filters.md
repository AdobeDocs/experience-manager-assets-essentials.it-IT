...
I filtri di ricerca personalizzati possono essere mappati solo alle voci nell’indice delle proprietà ricercabili. Assicurati di includere tutti i metadati personalizzati prima di configurare l’esperienza di filtro personalizzata. [!DNL Assets Essentials] consente di personalizzare i filtri di ricerca per semplificare il processo di ricerca. Per personalizzare il modello di filtri di ricerca, esegui i seguenti passaggi:
