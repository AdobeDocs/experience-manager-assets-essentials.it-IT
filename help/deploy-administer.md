...
# Distribuzione [!DNL Assets Essentials] e aggiungere utenti {#administer}

[!DNL Adobe Experience Manager Assets Essentials] è fornito per Adobe per i suoi clienti. Come parte del provisioning, [!DNL Assets Essentials] viene aggiunto all’organizzazione di un cliente in [!DNL Adobe Admin Console]. I clienti hanno anche accesso a [!DNL Experience Manager Cloud Manager] come strumento di distribuzione e [!DNL Admin Console] per gestire le adesioni utente a [!DNL Assets Essentials] soluzione.
